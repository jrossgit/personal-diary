...
urlpatterns = [
    ...
    path("todocategory:card_form", views.TaskCategoryCreateFormHTMXView.as_view(), name="htmx-todo-category-form"),
    path("todocategory:card", views.TaskCategoryCreateFormHTMXView.as_view(), name="htmx-todo-category-form"),
    path("todocategory/<uuid:todo_category_id>", views.TaskCategoryRetrieveHTMXView.as_view(), name="htmx-todo-category"),
    path("todocategory/<uuid:todo_category_id>:card_form", views.TaskCategoryCreateFormHTMXView.as_view(), name="htmx-todo-category-form"),
